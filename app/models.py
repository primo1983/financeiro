...
class Usuario(db.Model, UserMixin):
    ...
    saldos_visibilidade = db.Column(db.JSON, nullable=False, default=lambda: {"saldo_atual": True, "receita_mes": True, "despesa_mes": True, "saldo_mes": True})
...
class Categoria(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'nome', 'tipo', name='_user_id_nome_tipo_uc'),)
